...
const classes = {
    ...
    container1: "bg-violet-700 p-4 shadow-2xl rounded-[30px] w-[30%]",
    ...
    button: "text-violet-700 hover:text-white hover:bg-violet-700 hover:border-[0.5px] p-2 font-semibold flex justify-center w-full items-center",
